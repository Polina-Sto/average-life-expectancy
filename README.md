...
Как можно увидеть на графике, в 2021 году наблюдается сильная положительная корреляция (r = 0.8) между уровнем образования и продолжительностью жизни, что указывает на тесную связь между этими показателями. Однако это не означает, что образование напрямую увеличивает долголетие — возможны скрытые факторы (например, уровень дохода, доступ к медицине). Также показатель коррелирует с ВВП на душу населения на 65% - это является средним показателем корреляции.
...
Однако в 2023 году происходит немного другое. Здесь также можно наблюдать корреляцию между продолжительностью жизни и уровнем образования 0.91, с ВВП - 62%. Но также за 2023 год данные показывают, что показатель коррелирует с уровнем инвестиций в здравоохранение на 71%, что также является значительным. /> <br />
...
```python
x = df_final[['gdp_per_capita', 'health_spending', 'smart']]
...
2. **Главные факторы, влияющие на долголетие**  
   ...
   - Сильная связь с уровнем образования (r ≈ 0.91 в 2023 году) — чем выше образование, тем выше ожидаемая продолжительность жизни.
   - Значительное влияние ВВП на душу населения (r ≈ 0.62) — экономическое развитие играет важную роль.
   - Растущее влияние расходов на здравоохранение (r ≈ 0.71) — инвестиции в медицину дают результат.


4. **Рекомендации**  
   - Государствам с низкой продолжительностью жизни стоит инвестировать в **образование и здравоохранение**.
